...
$sentencia= $bd->prepare("SELECT *FROM permiso where idPermiso=? ;");
...
<form class="" action="actualizarPermiso.php" method="POST" enctype="multipart/form-data">
        
            
                    <div class="form-group">
                    <label for="exampleInputEmail1">Id Permiso *</label>
                    <input name="idPermiso" value="<?php echo $permiso->idPermiso ?>" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" email">
                    ...
                    <input name="nombre" value="<?php echo $permiso->nombre ?>" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" email">
                    <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
